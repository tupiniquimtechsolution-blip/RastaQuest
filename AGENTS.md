...
- `.claude/CLAUDE.md`, `QWEN.md` e `GEMINI.md` são adaptadores finos e não podem contradizer este contrato.
- Claude, Qwen, Kimi, DeepSeek, Gemini, GPT, Grok e outros modelos recebem estas regras através do harness/agente.
